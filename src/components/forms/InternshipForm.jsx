...
import { Briefcase, Save, Edit, Trash2, Plus } from 'lucide-react';

const InternshipForm = () => {
  const { data, loading, addData, updateData, deleteData } = useFormData('internships');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        resetForm();
        alert(isEditing ? 'Internship updated successfully!' : 'Internship added successfully!');
      } else {
  ...
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      <div style={{ 
        ...
        <Briefcase size={32} style={{ marginRight: '1rem', color: '#667eea' }} />
        <h1 style={{ margin: 0, color: '#333' }}>Internship Details</h1>
      </div>
      ...
      <div style={{
        ...
        <h2 style={{ 
          ...
          {isEditing ? 'Edit Internship Details' : 'Add Internship Details'}
        </h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: '1.5rem' }}>
            ...
            <textarea
              ...
              placeholder="Describe your internship experience, responsibilities, and achievements"
            />
          </div>
          ...
          <div style={{ display: 'flex', gap: '1rem' }}>
            ...
            >
              <Save size={16} />
              {isEditing ? 'Update' : 'Add'} Internship
            </button>
      ...
      {/* Data List */}
      <div>
        <h2 style={{ marginBottom: '1.5rem', color: '#333' }}>Your Internship Records</h2>
        ...
        {data.length === 0 ? (
          <div style={{
            ...
            <p>No internship records found. Add your first internship record above.</p>
          </div>
        ) : (
          <div style={{ 
            display: 'grid', 
